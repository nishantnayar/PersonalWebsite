...
export default function AboutPage() {
  const { name, title, tagline, bio, skills, social, location, avatarUrl, resumeUrl } = profile;
    ...
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
      ...
      <div className="flex flex-col-reverse md:flex-row md:items-start gap-10 md:gap-16">
        ...
        <div className="flex-1">
          ...
          {location && (
            <p className="flex items-center gap-1.5 text-sm text-gray-400 mb-8">
              <LocationIcon />
              {location}
            </p>
          )}
        ...
        <div className="flex-shrink-0">
          <div className="w-36 h-36 md:w-48 md:h-48 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-100 to-violet-100 flex items-center justify-center shadow-sm">
            {avatarUrl ? (
              <Image
                src={avatarUrl}
                alt={name}
              ...
              <span className="text-5xl md:text-6xl font-bold text-indigo-300 select-none">
                {name.charAt(0)}
              </span>
            )}
          </div>
